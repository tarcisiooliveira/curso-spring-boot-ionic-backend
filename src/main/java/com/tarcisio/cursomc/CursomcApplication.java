...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		estadoRepository.save(Arrays.asList(est1, est2));// o estado precisa ser criado antes, pois cidade depende de
															// estado
		cidadeRepository.save(Arrays.asList(c1, c2, c3));

		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36379812377", TipoCliente.PESSOAFISICA);
